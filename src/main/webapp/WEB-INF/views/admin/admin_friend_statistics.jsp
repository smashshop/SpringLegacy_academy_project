          ...
          <div class="content-wrapper">
            ...
            <div class="row ">
               ...
               <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">대륙별 동행모집 현황(모집 중)</h4>
              ...
              <h3 class="page-title"> 나라별 동행모집 현황(모집 중) </h3>
            </div>
            <div class="row">  
...
$(function() {
 ...
 var data_continent = {
		    datasets: [{
		      data: ["${select_continent_east_asia}", "${select_continent_southeast_asia}", "${select_continent_southwest_asia}",
		    	  "${select_continent_europe}", "${select_continent_america}", "${select_continent_oceania}",
		    	  "${select_continent_africa}"],
		      backgroundColor: [
		        'rgba(255, 99, 132, 0.5)',
		        'rgba(54, 162, 235, 0.5)',
		        'rgba(255, 206, 86, 0.5)',
