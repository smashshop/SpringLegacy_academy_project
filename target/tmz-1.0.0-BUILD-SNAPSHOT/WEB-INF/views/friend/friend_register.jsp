...
<div class="col-md-12 grid-margin stretch-card">
   <div class="card">
      ...
      <div class="card-body px-5"><h2>New Post</h2>

         <div class="img_wrapper my-4 file_upload_show" style="width: 100%; height: 350px;">
         	...
         	<div class="d-flex flex-row justify-content-between mx-2">
	           ...
	           <div>
	              <div class="row">
	                 ...
	                 <input type="date"
	                  		 max = "2099-12-31" name="frnd_startdate" class="form-control mr-2" id="user_birth"
	                    	 style="width: 150px;">
	                 <input type="date" max = "2099-12-31" name="frnd_enddate" class="form-control" id="user_birth"
	                    	 style="width: 150px;">
	              </div>               
	           </div>
        	</div>
		 ...
		 <div class = "col-7 my-4">
			...
			<input type="text" name = "frnd_tag" class="form-control" style = "color : white;" maxlength="30" placeholder="tag">
		 </div>         
         
	     <sec:authentication property="principal" var="principal"/>
         <input type="hidden" name="frnd_writer" value="${principal.username }"/>

         <input type="hidden" name="frnd_no" value="${frnd_info.frnd_no }" />
         
         <input type="hidden" name="frnd_tag" value="${friend.frnd_tag }" />
        ...
        <div class="form-group">
         ...
         <div class="float-right mt-3">
            <button type="submit" id="register_button"
               ...
               <i class="mdi mdi-border-color btn-icon-prepend"></i>등록
            </button>
...
frm.attr("method", "get");
   frm.attr("action", "${contextPath}/friend/friend-list");
   frm.submit();
});

$("#register_button").on("click", function() { // 수정 버튼 클릭시
   ...
   frm.attr("action", "${contextPath}/friend/friend-register");
   frm.submit();
});
...
function show_upload_image(upload_result) {
	...
	var file_upload_result = $(".file_upload_show");
	var str = "";
...
$.ajax({
		...
		success : function(upload_result, status) {		
			...
			$(".hidden_input").html(str_input_hidden);
		}
	})
});
